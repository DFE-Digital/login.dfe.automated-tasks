import { Access, type invitationServiceRecord } from "../../infrastructure/api/dsiInternal/Access";
import { type invitationOrganisationRecord, Organisations } from "../../infrastructure/api/dsiInternal/Organisations";
 ...
 */
export async function getInvitationApiRecords(apis: apiClients, invitationId: string, correlationId: string): Promise<invitationApiRecords> {
 ...
 */
export async function deleteInvitationApiRecords(apis: apiClients, invitationId: string, apiRecords: invitationApiRecords, correlationId: string): Promise<actionResult<string>> {
 ...
 */
export async function deleteInvitationDbRecords(invitationIds: string[]): Promise<void> {
  try {
